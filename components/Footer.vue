...
<footer fluid>
  <b-container fluid class="mt-4">
      <b-row>
        <b-col sm="12" md="12" class="text-center p-0">
         <p class="bg-black p-2">>> View our previous talks at <a alt="PowerShell.video" href="http://powershell.video">powershell.video</a></p>
        </b-col>
        <b-col sm="12" md="6">
      ...
      <b-row>
        <b-col sm="12">
          <p class="text-center p-4"><span class="bg-black p-2">psconf.eu &copy; 2021. All rights reserved.</span></p>
        </b-col>
      </b-row>
    </b-container>
</footer>
